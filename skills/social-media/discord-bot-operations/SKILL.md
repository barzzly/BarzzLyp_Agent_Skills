...
- When refreshing an existing panel, preserve its established visual language: exact emoji, list layout, wording, buttons, `@everyone`, and footer branding. Do not invent a plain replacement from product data; inspect the previous builder/source first.
